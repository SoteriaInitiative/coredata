...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--max_splits", type=int, default=3)
    p.add_argument("--scenario_probability", type=str, default='{"1":0.2,"2":0.1}')
    p.add_argument("--bank_knowledge", type=str, default='{"1":true,"2":false}')
    return p
